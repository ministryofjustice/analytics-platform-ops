...
// Fetch - retreive tags from EC2
func Fetch(connection *ec2.EC2, resourceID *string, filter string) (getTagsOutput *ec2.DescribeTagsOutput, filteredVal string, err error) {
...
// Resource - Tag an EC2 resource
func Resource(connection *ec2.EC2, resourceID string, tags []*ec2.Tag) (err error) {
